...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero with YouTube background video (autoplay, muted, loop) */}
      <section id="home" className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          {/* Scale and offset the iframe so the video fills the section (covers without letterbox) */}
          <iframe
            className="pointer-events-none"
            src="https://www.youtube.com/embed/-B25uHwt4H0?autoplay=1&mute=1&controls=0&loop=1&playlist=-B25uHwt4H0&modestbranding=1&rel=0&showinfo=0"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.facebook.com/dr.ricardotomas/" target="_blank" rel="noopener noreferrer" className="text-primary hover:opacity-70 transition-opacity">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.instagram.com/dr.ricardotomas/" target="_blank" rel="noopener noreferrer" className="text-primary hover:opacity-70 transition-opacity">
                ...
                <a href="https://www.youtube.com/@dr.ricardotomasoftalmologi9131" target="_blank" rel="noopener noreferrer" className="text-primary hover:opacity-70 transition-opacity">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:ricardotomas.dr@gmail.com" className="text-sm text-primary hover:underline">
                  ricardotomas.dr@gmail.com
                </a>
              </div>
            </div>
            <div className="flex items-start gap-3">
